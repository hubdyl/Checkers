...
public class ImageAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			// pobor layout z lay2.xml
			gridView = inflater.inflate(R.layout.lay2, null);
 
			// ustawienie obrazka bazujacego na zawartym texcie
			...
			if (data.equals("b")) {
				imageView.setImageResource(R.drawable.blackpiece); // jestli jest b ustaw czarny pionek
			} else if (data.equals("w")) {
				imageView.setImageResource(R.drawable.whitepiece); // jestli w ustaw bialy
			} else if (data.equals("B")) {
				// jesli B ustaw tam królowke
				if (position != 74) {
			...
			} else if (data.equals(".\n")) { // equals  ~ porwonanie jezeli jest prawdziwe zrob to i to
				imageView.setImageResource(R.drawable.whitepiece);
//				imageView.setVisibility(View.GONE);
			} else {
				imageView.setImageResource(R.drawable.whitepiece);
//				imageView.setVisibility(View.GONE);
			...
			// logika do ustawiania pionków na planszy /\
