...
public class MainActivity extends Activity {
	...
	GridView gridView;
	CheckersBoard cb = new CheckersBoard(); // tworzenie nowego gameboard
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		DisplayMetrics metrics = new DisplayMetrics();
		getWindowManager().getDefaultDisplay().getMetrics(metrics); // odbior wielkosci okna
		...
		myvec = cb.vec_string();
		gridView = (GridView) findViewById(R.id.gridview); // zapisanie do obiektu GridView naszego gridview z layoutu
